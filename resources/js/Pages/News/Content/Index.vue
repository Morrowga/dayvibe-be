        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <VCard class="bg-white shadow-none rounded-lg">
                    ...
                    <VCardText>
                        <div>
                            <Datatable :columns="columns" :paginationOptions="clientSidePaginationOptions" :rows="props.contents" :clientSideSearch="contentSearch" :action_url="'contents'" title="Content Deletion" />
                        </div>
                    </VCardText>
                </VCard>
            </div>
